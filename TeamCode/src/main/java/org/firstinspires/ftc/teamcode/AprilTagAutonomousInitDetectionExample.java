...
//        inches *= 1;
//        if(opModeIsActive()) {
//            leftFrontDrive.setPower(power * 1); // potentially *2 or +0.1 right front
//            leftBackDrive.setPower(power * 1); // potentially *2 or +0.1  right back
//            rightFrontDrive.setPower(power); // left front
//            rightBackDrive.setPower(power * 1); // left back
//
...
//        inches *= 1;
//        if(opModeIsActive()) {
//            leftFrontDrive.setPower(-power * 1); // potentially *2 or +0.1
//            leftBackDrive.setPower(-power * 1); // potentially *2 or +0.1
